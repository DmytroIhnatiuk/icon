...
function icon_scripts() {
	wp_enqueue_style( 'icon-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'icon-style', 'rtl', 'replace' );

	wp_enqueue_script( 'icon-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
